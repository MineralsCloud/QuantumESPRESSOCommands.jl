...
julia> pkg"dev QuantumESPRESSOCommands"
```

in Julia REPL.

Then the package will be cloned to your local machine at a path. On macOS, by default is
located at `~/.julia/dev/QuantumESPRESSOCommands` unless you modify the `JULIA_DEPOT_PATH`
...
[here](https://MineralsCloud.github.io/QuantumESPRESSOCommands.jl/dev), but there are cases
