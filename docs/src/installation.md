...
## Install `QuantumESPRESSOCommands`
...
version of `QuantumESPRESSOCommands`, type

```@repl
using Pkg
Pkg.update()
pkg"add https://github.com/MineralsCloud/QuantumESPRESSOCommands.jl"
```

in the second step above.

## Update `QuantumESPRESSOCommands`
...
our [GitHub repository](https://github.com/MineralsCloud/QuantumESPRESSOCommands.jl)
for new releases.
Once we release a new version, you can update `QuantumESPRESSOCommands` by typing

```@repl
using Pkg
Pkg.update("QuantumESPRESSOCommands")
Pkg.gc()
```

in the Julia REPL.

## Uninstall and reinstall `QuantumESPRESSOCommands`
...
1. To uninstall, in a Julia session, run
   ...
   julia> Pkg.rm("QuantumESPRESSOCommands")

   julia> Pkg.gc()
   ```

2. Press `ctrl+d` to quit the current session. Start a new Julia session and
   reinstall `QuantumESPRESSOCommands`.
