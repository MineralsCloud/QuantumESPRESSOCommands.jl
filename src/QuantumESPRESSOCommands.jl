...
@cast function pw(
    ...
    main = PwxConfig(; chdir = chdir, use_script = use_script)
    cmd = makecmd(
        input;
        output = output,
        error = error,
...
@cast function ph(
    ...
    mpi = MpiexecConfig(; np = np)
    main = PhxConfig(; chdir = chdir, use_script = use_script)
    cmd = makecmd(
        input;
        output = output,
        error = error,
...
@cast function q2r(
    ...
    mpi = MpiexecConfig(; np = np)
    main = Q2rxConfig(; chdir = chdir, use_script = use_script)
    cmd = makecmd(
        input;
        output = output,
        error = error,
...
@cast function matdyn(
    ...
    mpi = MpiexecConfig(; np = np)
    main = MatdynxConfig(; chdir = chdir, use_script = use_script)
    cmd = makecmd(
        input;
        output = output,
        error = error,
...
@cast function dynmat(
    ...
    mpi = MpiexecConfig(; np = np)
    main = DynmatxConfig(; chdir = chdir, use_script = use_script)
    cmd = makecmd(
        input;
        output = output,
        error = error,
